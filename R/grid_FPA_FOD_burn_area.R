...
# TODO: Check me again! This was written fast and not reviewed! 
...
# NOTE: This file has minDate = "2003-01-01 UTC" and maxDate = "2013-12-31 UTC"
...
lightning_burn_aera <- array(data=0, dim=c(nTime, nLon, nLat))
...
timedim <- ncdim_def("time", "YYYYMM of burn area", YYYYMM, TRUE) # unlimited == TRUE
...
dlname <- "burn_area"
burn_area.def <- ncvar_def("burn_aera","m**2",dimList,fillvalue,dlname,prec="float")

dlname <- "lightning_burn_aera"
lightning_burn_aera.def <- ncvar_def("lightning_burn_aera","m**2",dimList,fillvalue,dlname,prec="float")
